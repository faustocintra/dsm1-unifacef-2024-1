    ...
    <View style={styles.container}>
      ...
      <View style={styles.containerStories}>
        <View style={styles.containerStory}>
          ...
          <Image
            source={require("../../assets/joao3.jpg")}
            style={styles.story}
          />
          <Text>Seu story</Text>
        </View>
        ...
        <View style={styles.containerStory}>
          ...
          />
          <Image
            source={require("../../assets/fortune-tiger.jpg")}
            style={styles.story}
          />
          <Text>fortune_tiger</Text>
        </View>
        <View style={styles.containerStory}>
          <LinearGradient
            colors={["#F58529", "#DD2A7B", "#8134AF"]}
          ...
          />
          <Image
            source={require("../../assets/laacte.jpeg")}
            style={styles.story}
          />
          <Text>lacteameufii</Text>
        </View>
        <View style={styles.containerStory}>
          <LinearGradient
            colors={["#F58529", "#DD2A7B", "#8134AF"]}
      ...
      <View>
        ...
        <View style={styles.containerFeedHeader}>
          <View style={styles.userContainer}>
            ...
            />
            <Text style={styles.userName}>joao_faleiros11</Text>
          </View>
          <Image
        ...
        {/* Imagem do Feed */}
        <Image source={require("../../assets/amor2.jpg")} style={styles.feed} />
        ...
        <View style={styles.PostInfo}>
          ...
          <Text style={styles.PostText}>
            ...
            <Text> quero viver uma vida inteira com você! </Text>
          </Text>
        </View>
