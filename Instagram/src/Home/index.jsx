        ...
        <View>
          <View style={styles.containerFeedHeader}>
            <View style={styles.userContainer}>
              <Image source={require("../../assets/user.png")} style={styles.userFeed} />
              <Text style={styles.userName}>lucasrcintra</Text>
            </View>
            <Image source={require("../../assets/more.png")} style={styles.more} />
          </View>

          <Image source={require("../../assets/user.png")} style={styles.feed} />
          ...
          <View style={styles.PostInfo}>
            <Text style={styles.PostText}>
              Curtido por <Text style={[styles.userName, styles.PostText]}>testeee </Text>e{" "}
              <Text style={[styles.userName, styles.PostText]}>outras </Text>
              pessoas
            </Text>
            <Text style={styles.PostText}>
              <Text style={[styles.userName, styles.PostText]}>lucasrcintra</Text>
